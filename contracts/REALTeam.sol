...
/*****************************************************************************
 * @title REALTeam
 * @dev REALTeam is a token holder contract that will allow a
 * beneficiary to extract the tokens after a given release time.
 */
contract REALTeam is Ownable {
    using SafeMath for uint256;
    
    uint256 constant public AMOUNT_PER_RELEASE = 30000000 *10**18;
    ...
    uint256 constant public START_TIME = 1637971199 + 15552000; // Todo : Time begin unlock linearly 6 month from now
    // uint256 constant public START_TIME = 1635230912 + 2*60; // Test will be for now + 2minutes
    address constant public REAL_TOKEN = 0xa1B8bCeF70730e200dF36f0248295f4DC2081b9e; // Todo : REAL Token

    uint256 public lockToken = 150000000 * 10**18;
